...
// get an order by id
export const getOrder = async (req: NextRequest, { params }: { params: { id: string } }) => {
...
export const updateOrder = async (req: NextRequest, { params }: { params: { id: string } }) => {
    const { id } = await params;
...
// delete an order
export const deleteOrder = async (req: NextRequest, { params }: { params: { id: string } }) => {
    const { id } = await params;
