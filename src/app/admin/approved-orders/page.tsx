...
const approvedOrders: ApprovedOrder[] = [
  {
    orderId: "1a2b3c4d5e6f7g8h9i0j",
    product: "Wireless Headphones",
    customer: "John Doe",
    total: 299.99,
    res: "Order approved and ready for shipment.",
    date: "2025-01-01",
  },
  {
    ...
    customer: "Jane Smith",
    total: 799.99,
    res: "Order confirmed and processing.",
    date: "2025-01-05",
  },
  // Add more approved orders as needed
];
...
const Page: React.FC = () => {
  ...
  const confirmDelete = () => {
    if (orderToDelete) {
      ...
      const updatedOrders = approvedOrders.filter(
        (order) => order.orderId !== orderToDelete
      );
      // Update the approved orders list (if necessary in state or props)
